...
for _, name in ipairs({"NyxHub", "AceDuelsAdaptReconstruct", "AdaptHubPolished", "CyberHub"}) do
...
CONFIG_FILE = "NyxHub_Config.json"
KEYBINDS_CONFIG_FILE = "NyxHub_Keybinds.json"
...
INTRO_MUSIC_OPTIONS = INTRO_MUSIC_OPTIONS or {
    {name="Song 1", url="https://files.catbox.moe/mzvrir.mp3", file="NyxHubIntroSong_1.mp3"},
    {name="Song 2", url="https://files.catbox.moe/2a7jyx.mp3", file="NyxHubIntroSong_2.mp3"},
    {name="Song 3", url="https://files.catbox.moe/rcgr9f.mp3", file="NyxHubIntroSong_3.mp3"},
    {name="Song 4", url="https://files.catbox.moe/iknfuh.mp3", file="NyxHubIntroSong_4.mp3"},
    {name="Song 5", url="https://files.catbox.moe/6eigoh.mp3", file="NyxHubIntroSong_5.mp3"},
    {name="Song 6", url="https://files.catbox.moe/dvjtjk.mp3", file="NyxHubIntroSong_6.mp3"},
    {name="Song 7", url="https://files.catbox.moe/iyw1cb.mp3", file="NyxHubIntroSong_7.mp3"},
}
...
function cacheIntroSong(option, allowDownload)
    ...
    local fileName = option.file or ("NyxHubIntroSong_" .. tostring(option.name or "song") .. ".mp3")
...
function makeIntroSoundFromId(soundId, name, parent)
    ...
    sound.Name = name or "NyxHubIntroMusic"; sound.Volume = 0.65; sound.Looped = false; sound.SoundId = soundId; sound.Parent = parent or SoundService
    return sound
end
...
function previewIntroMusic(index)
    ...
    task.spawn(function()
        ...
        local sound = createIntroSound(option, "NyxHubIntroPreview_" .. tostring(token), SoundService, true)
...
function playIntroMusic()
    ...
    task.spawn(function()
        local sound = createIntroSound(option, "NyxHubIntroMusic_" .. tostring(token), SoundService, true)
...
local function setupOverheadInfo(char)
    ...
    overheadGui.Name = "NyxHubOverheadInfo"
...
-- ==================================================== --
-- NYX HUB UI REWRITE (PURPLE/BLACK, SQUARED, UBUNTU)  --
-- ==================================================== --
local COLORS = {
...
do
    ...
    function startPlayerESP()
        ...
        function setup(plr,char)
            ...
            hl.Name="NyxHubESP"; hl.Adornee=char; hl.FillColor=Color3.fromRGB(35,35,35); hl.FillTransparency=0.72
            ...
            bb.Name="NyxHubESPTag"; bb.Adornee=head; bb.Size=UDim2.new(0,124,0,34); bb.StudsOffset=Vector3.new(0,2.7,0); bb.AlwaysOnTop=true; bb.LightInfluence=0; bb.Parent=head
...
_G.__AceDuelsSetupSettingsUI = function()
    ...
    resetBtn.MouseButton1Click:Connect(function()
        ...
        pcall(function()
            local files = {CONFIG_FILE, KEYBINDS_CONFIG_FILE, "AceDuels_MainGUI_Config.json", "AceDuelsConfig.json", "AceDuels_Settings.json", "AceDuels_Keybinds.json", "AceDuels_GUI.json", "NyxHub_Config.json", "NyxHub_Keybinds.json"}
...
_G.__AceDuelsRunIntro = function()
    ...
    task.spawn(function()
        ...
        introGui.Name = "NyxHubIntro"; introGui.IgnoreGuiInset = true; introGui.DisplayOrder = 100; introGui.ResetOnSpawn = false; introGui.Parent = introGuiParent
        ...
        title.Text = "NYX HUB"; title.TextColor3 = COLORS.white; title.Font = Enum.Font.Ubuntu; title.TextSize = 72
...
task.defer(function()
    ...
    local old = PlayerGui:FindFirstChild("NyxMobileButtons")
    if old then old:Destroy() end
    local mobileGui = Instance.new("ScreenGui")
    mobileGui.Name = "NyxMobileButtons"
    ...
    function _G.AceApplyMobileButtonsHidden()
        local g = PlayerGui:FindFirstChild("NyxMobileButtons")
    ...
    function _G.AceApplyMobileButtonSize()
        ...
        pcall(function()
            local gui = PlayerGui:FindFirstChild("NyxHub")
