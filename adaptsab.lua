...
if type(data.mobileButtonPositions) == "table" then
    _G.AdaptMobileButtonPositions = data.mobileButtonPositions
end
...
local savedPos = type(_G.AdaptMobileButtonPositions) == "table" and _G.AdaptMobileButtonPositions[key] or nil
if type(savedPos) == "table" then
pos = tableToUDim2(savedPos, pos)
end
...
local savedInstaPos = type(_G.AdaptMobileButtonPositions) == "table" and _G.AdaptMobileButtonPositions.instaReset or nil
...
local savedInsta = type(_G.AdaptMobileButtonPositions) == "table" and _G.AdaptMobileButtonPositions.instaReset or nil
holder.Position = (type(savedInsta) == "table") and tableToUDim2(savedInsta, defaults.instaReset) or defaults.instaReset
holder.ZIndex = 1000
end
local btn = entry and entry.btn
if btn then
