...
Tabs.Discord:CreateDiscordInvite({
	Title = "Kurtis | Community",
	Description = "A community for Kurtis Hub Users - official scripts, updates, and suport in one place.",
	Banner = "rbxassetid://110167557685296", 
	Icon = "rbxassetid://120488231660846",
	Link = "https://t.me/kurtis_scripts",
    Button = "Join Server",
            ...
            while _G.AutoBuyMelee do
                ...
                if not data or not data.Pos then
                    MainWindow:Notify({
                        TitleWords = {
                            "Hệ thống ",
                            { Text = "Kurtis Hub", Colors = { Color3.fromRGB(255, 80, 80) } },
                        },
                        TextWords = {
                            "Trạng thái: ",
                ...
                if lp.Character and lp.Character:FindFirstChild("HumanoidRootPart") then
                    ...
                    if dist > 15 then
                        ...
                        MainWindow:Notify({
                            TitleWords = {
                                "Hệ thống ",
                                { Text = "Kurtis Hub", Colors = { Color3.fromRGB(80, 220, 80) } },
                            },
                            TextWords = {
                                "Đã mua thành công: ",
